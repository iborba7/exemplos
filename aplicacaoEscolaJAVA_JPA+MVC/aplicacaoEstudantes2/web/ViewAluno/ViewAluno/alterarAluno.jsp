...
<html>
    ...
    <body>
        ...
        <div><form id="form2" action="AlterarAluno?id=${aluno.id}" method="POST">
                ...
                <input type="text" name="nome" id="nome" value="${aluno.nome}" size="20"/><br/>
                <p>Alterar o cpf? ${aluno.cpf}</p>
                <input type="text" name="cpf" id="cpf" size="20" value="${aluno.cpf}"/><br/>
                <p>Alterar o número de Matrícula? ${aluno.matricula}</p>
                <input type="text" name="matricula" id="matricula" size="20" value ="${aluno.matricula}"><br/>
