...
<div class="container">
	...
	<?php
		$footer_sections = 0;
		$zerif_address = get_theme_mod('zerif_address',__('Nosso Endereço','zerif-lite'));
		$zerif_address_icon = get_theme_mod('zerif_address_icon',get_template_directory_uri().'/images/map25-redish.png');
		
		$zerif_email = get_theme_mod('zerif_email','<a href="mailto:atendefabricasas@gmail.com">atendefabricasas@gmail.com</a>');
		$zerif_email_icon = get_theme_mod('zerif_email_icon',get_template_directory_uri().'/images/envelope4-green.png');
		
		$zerif_phone = get_theme_mod('zerif_phone','<a href="tel:0 332 548 954">+55 (75) 99251-6314</a>');
